const categories = {
  ...
  titleSpanishCard: 'Spanish Courses',
  textSpanishCard:  `The second most spoken and studied language in the world. Opens many job
  opportunities and doors to the future. We invite you to explore the available courses and workshops.
  Courses based on the Instituto Cervantes.`,
  titleEnglishCard: 'English Courses',
  textEnglishCard:  `We offer dynamic and varied courses, also preparing for Cambridge exams for
