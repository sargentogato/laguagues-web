const why = {
  ...
  titleLanguage:    'Équipe Linguistique',
  ...
  objective: `Simuler la vie réelle et apprendre par immersion directe dans la pratique, tant pour nos cours réguliers que pour nos cours 
  plus exotiques.`,
